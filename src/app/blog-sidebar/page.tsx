...
export const metadata: Metadata = {
  title: "Blog Details Page Labfox",
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="mb-10 mt-12 rounded-sm bg-white p-6 shadow-three dark:bg-black dark:shadow-none lg:mt-0">
              ...
              <div className="mb-10 rounded-sm bg-white shadow-three dark:bg-black dark:shadow-none">
